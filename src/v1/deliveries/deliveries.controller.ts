...
export class DeliveriesController {
  ...
  @Get()
  findAll(@Query() pagination :QueryDto):Promise<PaginationResponseDto<DeliveryDto>>{
    try {
  ...
  @Patch(':id')
  update(@Param('id',ParseIntPipe) id:number,delivery:UpdateDeliveryDto):Promise<{id:number}>{
    try {
